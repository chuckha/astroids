...
return!0}return!1},
Bu:function(a,b){H.Wt(a,new J.MY(a,b))},
...
DE:function(a){if(!!a.$isJM)return["sendport",$globalState.oL,a.Jz,a.JE.gx6()]
...
z=new Error()
z.dartException=a
if("defineProperty" in Object){Object.defineProperty(z, "message", { get: H.lV.call$0 })
z.name=""}else z.toString=H.lV.call$0
...
$is_aB:true}}],["","astroid.dart",,K,{E2:function(){var z,y
z=K.Wx(document.querySelector("#game"))
y=$.lT()
$.lT().length
y.toString
if(typeof y!=="object"||y===null||!!y.immutable$list)H.vh(P.f("fill range"))
H.tE(y,0,256,!1)
z.cS()},HE:{"":"a;SB@,Dp@,Cq<,fQ<",
...
if(!(y>w+v)){v=this.gfQ()
if(typeof v!=="number")throw H.s(v)
z=z>x+v||y+a.gCq()<w}else z=!0}else z=!0
return!z},
...
if(z>y){x=this.gCq()
if(typeof x!=="number")throw H.s(x)
this.sSB(z-(y+x))}z=this.gDp()
y=$.FK
if(typeof z!=="number")throw z.D()
if(z>y){x=this.gfQ()
if(typeof x!=="number")throw H.s(x)
this.sDp(z-(y+x))}z=this.gSB()
y=this.gCq()
if(typeof y!=="number")throw y.J()
if(typeof z!=="number")throw z.C()
if(z<-y)this.sSB(z+($.jE+y))
z=this.gDp()
y=this.gfQ()
if(typeof y!=="number")throw y.J()
if(typeof z!=="number")throw z.C()
if(z<-y)this.sDp(z+($.FK+y))}},bz:{"":"HE;SB@,Dp@,nQ,wo,Cq<,fQ<,XS,f1,T6,fC,co",
ZP:function(){this.SB=this.SB+this.nQ
this.Dp=this.Dp+this.wo
this.aC()},
dd:function(a){J.b0(a)
a.drawImage($.EP(),16,0,8,8,this.SB,this.Dp,this.Cq,this.fQ)
a.restore()},
yW:function(a){var z=this.wC(a)
if(z)this.UA()
return z},
UA:function(){var z,y
if(this.XS>0){z=Math.random()+0.5*this.nQ
y=Math.random()+0.5*this.wo
$.lP().push(K.zo(this.Cq-16,this.fQ-16,this.XS-1,this.SB,this.Dp,-z,y))
$.lP().push(K.zo(this.Cq-16,this.fQ-16,this.XS-1,this.SB,this.Dp,z,-y))}C.Nm.Rz($.lP(),this)},
xG:function(a,b,c,d,e,f,g){this.SB=d
this.Dp=e
this.nQ=f
this.wo=g
this.XS=c
this.Cq=a
this.fQ=b},
static:{zo:function(a,b,c,d,e,f,g){var z=new K.bz(null,null,null,null,null,null,null,null,null,null,null)
z.xG(a,b,c,d,e,f,g)
return z}}},Em:{"":"HE;SB@,Dp@,Cg,Cq<,fQ<,VU<,f1,T6,fC,co",
ZP:function(){var z,y,x
this.VU=this.VU+1
z=$.lP()
y=P.F(z,!0,H.W8(z,"Q",0))
for(z=new H.a7(y,y.length,0,null);z.G();)if(z.mD.yW(this))this.VU=10000
z=this.SB
x=this.Cg
this.SB=z+Math.sin(x)*10
z=this.Dp
x=this.Cg
this.Dp=z+-Math.cos(x)*10
this.aC()},
dd:function(a){J.b0(a)
a.drawImage($.EP(),8,0,2,2,this.SB,this.Dp,this.Cq,this.fQ)
a.restore()}},wL:{"":"HE;Cq<,fQ<,SB@,Dp@,Cg,Eq,VU<,nG,bN,Vj,f1,T6,fC,co",
ZP:function(){var z,y,x
this.VU=this.VU+1
if(Math.abs(this.bN)<=$.fE)this.bN=0
if(Math.abs(this.Vj)<=$.fE)this.Vj=0
z=$.lT()
z.length
y=z[37]===!0?-0.08726646259971647:0
z=$.lT()
z.length
if(z[39]===!0)y+=0.08726646259971647
z=$.lT()
z.length
if(z[38]===!0){z=this.bN
x=this.Cg
this.bN=z+Math.sin(x)*0.2
z=this.Vj
x=this.Cg
this.Vj=z-Math.cos(x)*0.2}z=$.lT()
z.length
if(z[32]===!0&&this.VU-this.nG>25){this.nG=this.VU
this.Eq.push(new K.Em(this.SB,this.Dp,this.Cg,2,2,0,null,null,null,null))}for(z=this.Eq,x=new H.a7(z,z.length,0,null);x.G();)x.mD.ZP()
C.Nm.Bu(z,new K.x0())
z=this.bN
x=$.EA
if(z>x)this.bN=x
z=-x
if(this.bN<z)this.bN=z
if(this.Vj>x)this.Vj=x
if(this.Vj<z)this.Vj=z
this.SB=this.SB+this.bN
this.Dp=this.Dp+this.Vj
for(z=$.lP(),z=new H.a7(z,z.length,0,null);z.G();)if(z.mD.wC(this))$.Wq=!0
this.aC()
this.bN=this.bN*0.97
this.Vj=this.Vj*0.97
this.Cg=this.Cg+y},
dd:function(a){var z
for(z=this.Eq,z=new H.a7(z,z.length,0,null);z.G();)z.mD.dd(a)
J.b0(a)
a.translate(this.SB,this.Dp)
a.rotate(this.Cg)
a.translate(-8,-16)
a.drawImage($.EP(),0,0,8,13,0,0,this.Cq,this.fQ)
a.restore()},
pF:function(){this.SB=250
this.Dp=250
this.Cq=16
this.fQ=16
this.Cg=0
this.VU=0
this.nG=-50},
static:{"":"fE,wb,EA",Nv:function(){var z=new K.wL(null,null,null,null,null,[],null,null,0,0,null,null,null,null)
z.pF()
return z}}},x0:{"":"Tp;",
call$1:function(a){return a.gVU()<$.wb},
$is_aB:true},fq:{"":"a;Le,R,fg,Ee,BB,eI",
cS:function(){var z,y
this.Ee=J.PB(this.Le,"2d")
J.ob(this.Ee,!1)
...
z[y]=!0}},
gHQ:function(a){return new K.C7(this,K.fq.prototype.Ql,a,"Ql")},
...
if(y>>>0!==y||y>=256)throw H.e(z,y)
z[y]=!1}},
gS0:function(a){return new K.C7(this,K.fq.prototype.t4,a,"t4")},
WE:function(a){var z,y
z=P.Gi().rq
y=0+(z-this.eI)*60/1000
this.eI=z
if(y>10)y=10
for(;y>1;){this.ZP();--y}this.Ww()
if(!$.Wq)C.ol.gm6(window).ml(this.gtV())},
gtV:function(){return new H.Pm(this,K.fq.prototype.WE,null,"WE")},
ZP:function(){if($.lP().length===0&&!$.Wq)$.Ap=!0
for(var z=$.lP(),z=new H.a7(z,z.length,0,null);z.G();)z.mD.ZP()
for(z=$.Y3(),z=new H.a7(z,z.length,0,null);z.G();)z.mD.ZP()},
Ww:function(){J.Eu(this.Ee,0,0,this.R,this.fg)
if($.Wq)J.wE(this.Ee,"Game Over!",10,20,500)
else if($.Ap)J.wE(this.Ee,"You WIN!!",10,20,500)
else{for(var z=$.lP(),z=new H.a7(z,z.length,0,null);z.G();)z.mD.dd(this.Ee)
for(z=this.BB,z=new H.a7(z,z.length,0,null);z.G();)z.mD.dd(this.Ee)}},
V6:function(a){var z,y
this.Le=a
this.R=a.clientWidth
this.fg=a.clientHeight
z=K.Nv()
$.Y3().push(z)
y=K.zo(64,64,3,10,10,3,3)
$.lP().push(y)
this.BB.push(z)},
static:{Wx:function(a){var z=new K.fq(null,null,null,null,[],P.Gi().rq)
z.V6(a)
return z}}}},1],["dart._collection.dev","dart:_collection-dev",,H,{Zi:function(a,b,c,d,e){var z,y,x
...
for(z=new H.a7(a,a.length,0,null);z.G();)b.call$1(z.mD)},Wt:function(a,b){var z,y,x,w,v
z=[]
y=a.length
...
if(v===y)return
C.Nm.sB(a,v)
for(x=0;x<z.length;++x)C.Nm.u(a,x,z[x])},mx:function(a,b,c){var z,y,x
...
$isiP:true,
static:{"":"Oj,Vp,df,p2,h2,QC,nm,Yp,kc,Xs,k3,cR,E0,Ke,kT,Nr,bm,o4,Kz,ek,yf,Fk",Gi:function(){var z=new P.iP(Date.now(),!1)
z.EK()
return z}}},Hn:{"":"Tp;",
...
z.PD(a)
return z}}},wv:{"":"a;"}}],["dart.dom.html","dart:html",,W,{jm:function(a,b,c){var z=document.createElement("img",null)
J.Yj(z,b)
J.vP(z,c)
J.OE(z,a)
...
$isqC:true,
$isXj:true,
"%":";Uint8Array"},xG:{"":"AS+lD;",$isList:true,$aszM:null,$isqC:true},Vj:{"":"xG+SU;",$aszM:null}}],])
I.$finishClasses($$,$,null)
$$=null
init.globalFunctions.NB=H.NB=new H.Wv(H.Mg,"NB")
init.globalFunctions.lV=H.lV=new H.yh(H.Ju,"lV")
...
J.yH=function(a){return J.vd(a).Vy(a)}
...
I.$lazy($,"keysDown","w1","lT",function(){var z=P.A(256,J.kn)
H.VM(z,[J.kn])
return z})
I.$lazy($,"sheet","Jj","EP",function(){return W.jm(256,"images/sheet.png",256)})
I.$lazy($,"tickers","Jv","Y3",function(){return[]})
I.$lazy($,"astroids","di","lP",function(){return[]})
...
//# sourceMappingURL=astroid.dart.js.map
//@ sourceMappingURL=astroid.dart.js.map
